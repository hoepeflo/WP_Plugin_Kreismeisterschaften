...
3. Die Bilder zum Ablauf nach der Buchungsfrist entstehen der Reihe nach: erst der Block
   mit den Startern ohne Platz, dann „Rest verteilen“ klicken, dann veröffentlichen.
4. Version und Stand in `anleitung-admin.html` anpassen.
5. PDF drucken, zum Beispiel über den Druckdialog des Browsers (A4, Hintergrundgrafiken
