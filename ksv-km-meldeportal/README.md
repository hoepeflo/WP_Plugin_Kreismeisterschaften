...
Uhrzeit, Spalten die Stände, in der Zelle Verein, Name und Startklasse. Die Disziplin
steht nur dann am einzelnen Startplatz, wenn es an dem Tag mehrere gibt – sonst reicht
die Kopfzeile. Er zeigt erst nach der Veröffentlichung Inhalte und nur Name,
