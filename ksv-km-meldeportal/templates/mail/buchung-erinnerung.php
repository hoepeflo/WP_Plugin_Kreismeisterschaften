...
echo sprintf("Die Buchungsfrist endet am %s Uhr. Bis dahin können Sie die Plätze im Meldeportal unter „Startplätze“ selbst wählen; danach verteilt der KSV die restlichen Starter auf freie Plätze.\n\n", $frist);
echo $url . "\n\n";
